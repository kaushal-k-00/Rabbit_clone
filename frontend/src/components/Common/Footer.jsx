  ...
  return (
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 rounder-l-md focus:outline-none
        ...
        {/* follows us */}
        <div>
          <h3 className="text-lg mb-4 text-gray-800"></h3>
          <div className="flex items-center space-x-4 mb-6">
            ...
            <a
              ...
              className="hover:text-gray-300"
            >
              <RiTwitterXLine className="h-4.5 w-5" />
            </a>
          </div>
